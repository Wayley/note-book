...
import AnalysisResult from '../views/Dashboard/AnalysisResult/AnalysisResult';
import CollectingStatusTotal from '../views/Dashboard/CollectingStatusTotal/CollectingStatusTotal';
import FailAnalysis from '../views/Dashboard/FailAnalysis/FailAnalysis';
            ...
            <Switch>
              <Route path="/dashboard">
                <Switch>
                  ...
                  <Route path="/dashboard/analysis-result">
                    <AnalysisResult />
                  </Route>
                  <Route path="/dashboard/collecting-status-total">
                    <CollectingStatusTotal />
                  </Route>
                  <Route path="/dashboard/fail-analysis">
                    <FailAnalysis />
                  </Route>
                </Switch>
              </Route>
